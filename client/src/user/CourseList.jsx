...
import { Search, Calendar, BookOpen, Users, TrendingUp, Star } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Transform your future with our expert courses designed for your success
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-4">
              <select
                className="px-4 py-3 rounded-lg border border-gray-200 bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
                value={batch}
                ...
                <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full">
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 text-gray-600 mb-3">
                      ...
                      <span className="text-sm font-medium">{course.month}</span>
                    </div>
